    ...
    return (
        <main className="min-h-screen flex flex-col md:flex-row items-center justify-between px-0 md:px-0 py-12 gap-20 mt-10">
            ...
            <div className="flex md:w-1/2 -mt-4 -pt-40 md:-mt-40 md:-pt-40 relative px-4 md:px-0">
                ...
                <div className="space-y-2 sm:space-y-4 absolute top-72 sm:top-64 md:top-48 -left-4 sm:left-0 translate-x-1/4 sm:-translate-x-1/4 -translate-y-6 -mt-14 md:mt-40 px-0 md:px-0">
                    {[
