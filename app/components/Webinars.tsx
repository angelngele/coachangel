...
export default function HeroSection() {
    return (
        <main className="px-6 md:px-20 bg-white">
            {/* Section Tagline */}
            ...
            <motion.section
                ...
                className="flex justify-center px-0 md:px-0 mx-auto flex-col lg:flex-row items-center gap-20"
            >
                {/* Text Section */}
                <div className="flex-1 flex flex-col justify-center -mx-11 md:mx-0">
